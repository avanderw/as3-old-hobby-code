package avdw.demo.terrain {
	...
	public class TwoDeeMidpointDisplacement extends Sprite {
		...
		public function TwoDeeMidpointDisplacement():void {
			if (stage)
				init();
			else
		...
		private function generate(e:MouseEvent = null):void {
			 ...
			 *
			   ...
			   shading.scaleX = bmp.scaleX;
			   shading.scaleY = bmp.scaleY;
			 addChild(shading);*/
			...
			// update text
			txt.text = "Midpoint Displacement" +
					   "\n---------------------------------------" +
			    "\nclick to generate" +
